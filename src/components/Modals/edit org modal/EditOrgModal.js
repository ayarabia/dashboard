...
const EditOrgModal = ({ getOrganisationsData, updateData, deleteId }) => {
  ...
  const formSubmit = async (e) => {
    ...
    if(isValid) {
      setLoading(true)
      seterrorlist(null);
    Service.updateOrg(deleteId, addDataState)
      .then(() => {
        setLoading(false);
        handleCloseModal();
        // setAddDataState({});
          ...
          <div className="modal-body rounded-3 shadow-sm mb-3 ">
            <form action="">
              <div className="d-flex justify-content-between flex-wrap py-4 px-5">
                <h4 className="w-100 text-center mt-0 text-main">
                  {updateData?.name}
                </h4>
                ...
                <div className=" item mb-3">
                  <label htmlFor="orgadd" className="form-label">
                    Organisation Address<span className="text-danger">*</span>
                  </label>
                  <input
                    type="text"
                    className="form-control"
                ...
                <div className=" item mb-3">
                  <label htmlFor="orgCountry" className="form-label">
                ...
                <div className=" item mb-3">
                  <label htmlFor="orgPerson" className="form-label">
                  ...
                  <input
                    ...
                    defaultValue={updateData?.person_in_charge_name}
                  />
                </div>
                <div className="row row50">
                  <div className="col-lg-6">
                    <div>
                      <div className="  mb-3">
                        <label htmlFor="orgPillAdress" className="form-label">
                        ...
                        <input
                          ...
                          defaultValue={updateData?.billing_address}
                        />
                      </div>
                      <div className="  mb-3">
                        <label htmlFor="orgShipAddress" className="form-label">
                        ...
                        <input
                          ...
                          defaultValue={updateData?.shipping_address}
                        />
                      </div>
                    </div>
                  </div>
