...
const EditDifficultyGroups = ({ getData, updateData, deleteId }) => {
  const [addDataState, setAddDataState] = useState(updateData);
...
console.log(addDataState);
  ...
  function handleCloseModal() {
    document.getElementById("editDiffModal").classList.remove("show", "d-block");
    document
  ...
  return (
    <div
      ...
      id="editDiffModal"
      tabIndex={-1}
      aria-labelledby="editDiffModalLabel"
      aria-hidden="true"
    >
      <div className="modal-dialog">
        <div className="modal-content px-5">
                ...
                <div className="col-lg-6">
                  <div className="form-check form-switch d-flex justify-content-between px-5  ">
                    <label
                      ...
                      htmlFor="assignDefaultSwitchCheck"
                    >
          ...
          <div className="d-flex justify-content-end mb-4">
            ...
            >
              <i className="fa-solid fa-floppy-disk me-3"></i> <span>Save</span>
            </button>
          </div>
        </div>
      </div>
