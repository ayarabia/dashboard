...
const UpdateSchoolModal = ({ getSchoolsData, updateData, deleteId }) => {
  ...
  const formSubmit = async (e) => {
    ...
    const isValid = await schema
      .validate(addDataState)
      .catch((error) => seterrorlist(error.errors));
    ...
    if (isValid) {
      setLoading(true);
      seterrorlist(null);
   Service.updateSchool(deleteId, addDataState)
        .then(() => {
          setLoading(false);
          handleCloseModal();
          getSchoolsData();
  ...
  function handleCloseModal() {
    document
      .getElementById("updateSchoolModal")
...
return (
    <div
      ...
      id="updateSchoolModal"
      tabIndex={-1}
      aria-labelledby="updateSchoolModalLabel"
      aria-hidden="true"
    >
      <div className="modal-dialog">
        <div className="modal-content px-5">
          <div className="modal-header d-block">
            ...
            {errorlist && (
              <p className="text-danger w-100 text-center">{errorlist[0]}</p>
            )}
            <button
              type="button"
              className="btn-close"
          ...
          <div className="modal-body  ">
            <form onSubmit={formSubmit}>
              <div className="row">
                ...
                <div className="col-lg-6">
                  <div className="mb-3">
                    <label htmlFor="schoolpostal_code" className="form-label">
                       Postal Code
                    </label>
                    <input
                      onChange={getData}
                      ...
                      type="number"
                      className="form-control"
                      id="schoolpostal_code"
                      placeholder="Enter postal code"
                      defaultValue={updateData?.postal_code}
                    />
                  </div>
                </div>
                <div className="col-lg-6">
                ...
                <div className="col-lg-6">
                  <div className="mb-3">
                    <label htmlFor="schoolcountry_id" className="form-label">
                      {" "}
                      Country
                    </label>
                    <input
                      ...
                      defaultValue={updateData?.country_id}
                    />
                  </div>
                </div>
                <div className="col-lg-6">
                  <div className="mb-3">
                    <label
                      htmlFor="schoolis_tution_centre"
                    ...
                    <div>
                      <div className="form-check">
                        <input
                          ...
                          type="radio"
                          name="is_tution_centre"
                          id="flexRadioDefaultsd1"
                          value={1}
                        />
                        <label
                          className="form-check-label"
                          htmlFor="flexRadioDefaultsd1"
                        >
                          yes
                        </label>
                      </div>
                      <div className="form-check">
                        <input
                          ...
                          type="radio"
                          name="is_tution_centre"
                          id="flexRadioDefault296"
                          value={0}
                        />
                        <label
                          className="form-check-label"
                          htmlFor="flexRadioDefault296"
                        >
                          no
                        </label>
                      </div>
